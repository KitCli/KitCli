...
public class InstructionTokenExtractorTests
{
    ...
    public void GivenInputString_WhenParse_ReturnsInstructionPrefixs()
    {
        ...
        var indexes = new InstructionTokenIndexCollection
        {
            [InstructionTokenType.Prefix] = new InstructionTokenIndex
            {
                Found = true,
                StartIndex = 0,
                EndIndex = 1
            },
            [InstructionTokenType.Name] = new InstructionTokenIndex
            {
                Found = true,
                StartIndex = 1,
                EndIndex = 7
            },
            [InstructionTokenType.SubName] = new InstructionTokenIndex
            {
                Found = false
            },
            [InstructionTokenType.Arguments] = new InstructionTokenIndex
            {
                Found = false
            }
        };
