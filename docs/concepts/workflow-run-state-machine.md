...
- [command-registration.md](command-registration.md) — how
  `ICliWorkflowCommandProvider.GetCommand` resolves the instruction this
  doc's `RespondToAsk` walkthrough passes it.
